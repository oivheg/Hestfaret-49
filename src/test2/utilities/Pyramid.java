 ...
 *
 * <p> A pyramid is defined by a width at the base and a height. The pyramid is
 * a 4-sided pyramid with the center at (0,0), it will be axis aligned with the
 * peak being on the positive y axis and the base being in the x-z plane. <p>
 ...
 * 
 * http://jmonkeyengine.org/groups/contribution-depot-jme3/forum/topic/jme3-pyramid/
 *
 * @author Denis Hock
 */
public class Pyramid extends Mesh {
     ...
     * <code>Pyramid</code> object. The base width and the height are provided.
     *
